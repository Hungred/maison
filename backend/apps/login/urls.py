...
urlpatterns = [
    ...
    path('active_management/<str:user>', views.active_management, name='active_management'),
    path('remove_management/<str:user>', views.remove_management, name='remove_management'),
